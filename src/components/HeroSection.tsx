      ...
      <div className="relative z-10 text-center section-padding max-w-4xl mx-auto">
        <div className="mb-8 animate-fade-in">
          ...
          <p className="text-xl sm:text-2xl text-text-secondary mb-8 font-light">
            CE @ University of Waterloo. Passionate about{" "}
            <span className="text-accent-primary font-medium">AI/ML</span>,{" "}
            <span className="text-accent-primary font-medium">Robotics</span>,
            and{" "}
        ...
        <div
          className="flex justify-center gap-6 animate-scale-in"
        ...
        >
          ...
          <a
            href="https://www.linkedin.com/in/nengjiali/"
            target="_blank"
            rel="noopener noreferrer"
            className="social-link"
          >
          ...
          <a href="mailto:nengjiali@gmail.com" className="social-link">
            <Mail size={24} />
          </a>
        </div>
